...
Route::get('/filter_presensi',[PresensisiswaController::class,'filter_presensi']);
Route::get('/cetak_presensi/{id}', [PresensisiswaController::class, 'print']);
Route::post('/terimapresensi/{id}',[PresensisiswaController::class,'terimapresensi']);
Route::post('/tolakpresensi/{id}',[PresensisiswaController::class,'tolakpresensi']);
