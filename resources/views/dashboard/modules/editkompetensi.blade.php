    ...
    <div class="container px-5 mt-10 bg-white pb-5 overflow-auto w-full mx-auto">
        <div class="bg-white pb-10 w-full">
            ...
            <div class="w-full text-center mb-10 pt-5">
                <p class="font-extrabold">KOMPETENSI</p>
            </div>

            @foreach($datakompetensi as $d)
            <form action="/kompetensi/update" method="POST">
                <!-- {{csrf_field()}} -->
                @csrf
                <!-- @method('post') -->
                ...
                <div class=" w-full px-2  font-bold">
                    ...
                    <div class="w-full">
                        ...
                        <input type="hidden" id="id_kompetensi" name="id_kompetensi" value="{{$d->id_kompetensi}}" />
                        <label for="">{{$d->nama_kompetensi}}</label>
                        <input type="text" name='nama_kompetensi' value="{{$d->nama_kompetensi}}"
