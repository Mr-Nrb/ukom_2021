            ...
            <form action="/jurusan/update" method="POST">
                ...
                <div class=" w-full px-2  font-bold">
                    ...
                    <div class="w-full">
                        ...
                        <input type="hidden" id="id_jurusan" name="id_jurusan" value="{{$d->id_jurusan}}" />
                        <label for="">{{$d->nama_jurusan}}</label>
                        <input name='nama_jurusan' value="{{$d->nama_jurusan}}"
                        ...
                        <br>
                        <input type="text" name="akronim" id="akronim" value="{{$d->akronim}}" 
