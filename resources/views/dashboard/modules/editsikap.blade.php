    ...
    <div class="container px-5 mt-10 bg-white pb-5 overflow-auto w-full mx-auto">
        <div class="bg-white pb-10 w-full">
            ...
            <div class="w-full text-center mb-10 pt-5">
                <p class="font-extrabold">Form Nilai Sikap Siswa</p>
            </div>

            @foreach($datasikap as $d)
            <form action="/sikap/edit/update" method="POST">
                {{csrf_field()}}
                ...
                <div class=" w-full px-2  font-bold">
                    ...
                    <div class="w-full">
                        ...
                        <label for="">Disiplin Waktu</label>
                        <input type="number" max="100" min="1" name='disiplin_waktu' value="{{$d->disiplin_waktu}}"
                            class="rounded-md shadow-inner w-full border border-gray-400">

                        <br>

                        <label for="">Kemauan Kerja dan Motivasi</label>
                        <input type="number" max="100" min="1" name="kemauan_kerja_dan_motivasi" value="{{$d->kemauan_kerja_dan_motivasi}}"
                            class="rounded-md shadow-inner w-full border border-gray-400">

                        <br>

                        <label for="">Kualitas Kerja</label>
                        <input type="number" max="100" min="1" name="kualitas_kerja" value="{{$d->kualitas_kerja}}"
                            class="rounded-md shadow-inner w-full border border-gray-400">

                        <br>

                        <label for="">Inisiatif Kerja</label>
                        <input type="number" max="100" min="1" name="inisiatif_kerja" value="{{$d->inisiatif_kerja}}"
                            class="rounded-md shadow-inner w-full border border-gray-400">

                        <br>

                        <label for="">Perilaku</label>
                        <input type="number" max="100" min="1" name="perilaku" value="{{$d->perilaku}}"
                            class="rounded-md shadow-inner w-full border border-gray-400">
